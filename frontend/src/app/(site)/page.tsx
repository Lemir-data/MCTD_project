  ...
  return (
    <div>
      ...
      <section
        ...
        style={{ minHeight: "min(92svh, 900px)", backgroundColor: "#122a4e" }}
      >
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16 pt-44">
          ...
          <HeroText delay={0.2}>
            ...
            <div className="flex gap-2 mt-8" role="tablist" aria-label="Navigation du diaporama">
              {heroImages.map((_, i) => (
                <button
                  key={i}
                  type="button"
          ...
          <StaggerContainer className="space-y-1">
            {engagements.map((item, i) => (
              <StaggerItem key={item.title}>
                <div className={`flex items-start gap-4 py-5${i < engagements.length - 1 ? " border-b border-gray-100" : ""}`}>
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0 mt-0.5" style={{ backgroundColor: "#EFF6FF" }}>
      ...
      <section className="py-12 md:py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn>
            <Heart size={48} className="inline-block mb-4" style={{ color: "#C8941A" }} />
