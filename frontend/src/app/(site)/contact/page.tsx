              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-3 border border-gray-200 rounded-lg text-sm ${sujet === "" ? "text-gray-400" : "text-gray-700"} ${focusClass}`}
                  >
                    <option value="" disabled hidden>Choisir un sujet</option>
                    <option className="text-gray-700">Information générale</option>
                    <option className="text-gray-700">Formations E-Learning</option>
                    <option className="text-gray-700">Événements</option>
                    <option className="text-gray-700">Dons et financement</option>
                    <option className="text-gray-700">Autre</option>
                  </select>
                </div>
                <div>
